...
const mascotas_t mascotas2 = { .numPerros = 0, .numGatos = 0, .numOtras = 0, };
const mascotas_t mascotas3 = { .numPerros = 0, .numGatos = 7, .numOtras = 0, };
const mascotas_t mascotas4 = { .numPerros = 0, .numGatos = 7, .numOtras = 0, };
const mascotas_t mascotas5 = { .numPerros = 1, .numGatos = 7, .numOtras = 0, };

const depto_t deptoArrendatario =\
{ .renta = 12345,
...
TEST_CASE("encuentraDeptosMayorRenta()") {
  ...
  int deptosMayorRentaEsperados[] = {0, 2};
...
TEST_CASE("CantNinios()"){
  CHECK(CantNinios(&edificio[0][0], deptosPorPiso, pisos) == 8);
}
